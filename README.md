...
| `antigravity-gemini-3.7-flash` | minimal, low, medium, high | Gemini 3.7 Flash with thinking (medium default) |
| `antigravity-gemini-3.8-flash` | minimal, low, medium, high | Gemini 3.8 Flash with thinking (medium default) |
