...
| Level | 3/3.5/3.7/3.8 Flash | 3.6 Flash | 3.5 Flash-Lite | Pro | Description |
|-------|---------------------|-----------|----------------|-----|-------------|
...
> Defaults are model-specific: Gemini 3.6, 3.7, & 3.8 Flash use `medium`, Gemini 3.5 Flash-Lite uses `minimal`, and existing plugin models retain their current defaults.
