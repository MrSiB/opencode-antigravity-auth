...
| Model Name | Model ID / Internal Endpoint ID | Type | Status |
|------------|---------------------------------|------|--------|
...
| Gemini 3.6 Flash | `gemini-3.6-flash-tiered` / `gemini-3.6-flash` | Google | ✅ Verified |
| Gemini 3.5 Flash | `gemini-3.5-flash-low` / `gemini-3.5-flash` | Google | ✅ Verified |
| Gemini 3.1 Pro | `gemini-3.1-pro` | Google | ✅ Verified |
