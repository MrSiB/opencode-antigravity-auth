...
2. Ensure provider.google is configured in ~/.config/opencode/opencode.json with valid model definitions (e.g., antigravity-gemini-3.6-flash, antigravity-claude-opus-4-6-thinking, antigravity-gemini-3.5-flash).
3. Set the default provider/model to google/antigravity-claude-opus-4-6-thinking or google/antigravity-gemini-3.6-flash.
