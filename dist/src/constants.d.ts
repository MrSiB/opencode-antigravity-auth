 ...
 */
export declare const ANTIGRAVITY_ENDPOINT_DAILY = "https://cloudcode-pa.googleapis.com";
 ...
 * Sandbox/daily endpoints are strictly prohibited to prevent API key errors.
 */
export declare const ANTIGRAVITY_ENDPOINT_FALLBACKS: readonly ["https://cloudcode-pa.googleapis.com"];
/**
 * Preferred endpoint order for project discovery (prod only).
 */
export declare const ANTIGRAVITY_LOAD_ENDPOINTS: readonly ["https://cloudcode-pa.googleapis.com"];
/**
 ...
 */
export declare const ANTIGRAVITY_DEFAULT_PROJECT_ID = "your-project-id";
