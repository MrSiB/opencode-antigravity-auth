 ...
 */
export declare function resolveThinkingConfig(userConfig: ThinkingConfig | undefined, isThinkingModel: boolean): ThinkingConfig | undefined;
/**
 ...
 */
export declare function getThinkingText(part: any): string;
/**
...
export declare function extractAgentPersona(payload: unknown): string;
