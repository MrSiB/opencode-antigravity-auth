import { type AccountStorageV4, type AccountMetadataV3, type RateLimitStateV3, type ModelFamily, type HeaderStyle, type CooldownReason, type AccountTokenUsageState } from "./storage.js";
...
export declare class AccountManager {
    ...
    clearAccountVerificationRequired(accountOrIndex: number | ManagedAccount, enableAccount?: boolean): boolean;
     ...
     */
    ensureAccountProjectContext(accountOrIndex: number | ManagedAccount): Promise<ProjectContextResult | null>;
    ...
    updateQuotaCache(accountIndex: number, quotaGroups: Partial<Record<QuotaGroup, QuotaGroupSummary>>, geminiCliQuota?: GeminiCliQuotaSummary): void;
...
export declare function clearAccountVerificationRequired(account: ManagedAccount, enableAccount?: boolean): boolean;
