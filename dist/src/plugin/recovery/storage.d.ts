...
export declare function messageHasContent(sessionID: string, messageID: string): boolean;
...
export declare function stripThinkingParts(messageID: string, sessionID?: string): boolean;
