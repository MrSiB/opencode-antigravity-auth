...
import { type AntigravityUsageMetadata } from "./request-helpers";
...
export declare function sanitizeAccountEmail(email: unknown): string | null;
export declare function reportTokenUsageTelemetry(requestPayload: unknown, model: string | undefined, usage: AntigravityUsageMetadata | null | undefined, statsFilePath?: string, accountEmail?: string, projectId?: string, sessionId?: string): TokenUsageTelemetryEntry | null;
declare function getDisplayedThinkingHashes(sessionId: string | undefined): Set<string> | undefined;
 ...
 */
export declare function transformAntigravityResponse(response: Response, streaming: boolean, debugContext?: AntigravityDebugContext | null, requestedModel?: string, projectId?: string, endpoint?: string, effectiveModel?: string, sessionId?: string, toolDebugMissing?: number, toolDebugSummary?: string, toolDebugPayload?: string, debugLines?: string[], requestPayload?: unknown, accountEmail?: string): Promise<Response>;
export declare const __testExports: {
    ...
    getDisplayedThinkingHashes: typeof getDisplayedThinkingHashes;
