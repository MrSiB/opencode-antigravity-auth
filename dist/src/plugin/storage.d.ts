 ...
 */
export declare function calculateEmpiricalCapacity(tokensUsed: number, remainingFraction?: number): number | undefined;
...
export declare function addTokensToUsageState(state: AccountTokenUsageState | undefined, _family: string, tokens: number, now?: number): AccountTokenUsageState;
export declare function getRollingTokenUsage(state: AccountTokenUsageState | undefined, _family: string, windowMs: number, now?: number): number;
