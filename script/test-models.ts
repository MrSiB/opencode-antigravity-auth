...
const MODELS: ModelTest[] = [
  ...
  { model: "google/antigravity-gemini-3.7-flash-high", category: "antigravity-gemini" },
  { model: "google/antigravity-gemini-3.7-flash-minimal", category: "antigravity-gemini" },
