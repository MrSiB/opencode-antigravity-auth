 ...
 */
export declare const createAntigravityPlugin: (providerId: string) => (ctx?: PluginContext) => Promise<PluginResult>;
export declare const AntigravityCLIOAuthPlugin: (ctx?: PluginContext) => Promise<PluginResult>;
export declare const GoogleOAuthPlugin: (ctx?: PluginContext) => Promise<PluginResult>;
