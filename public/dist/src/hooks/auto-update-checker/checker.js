...
import { PACKAGE_NAME, LEGACY_PACKAGE_NAME, NPM_REGISTRY_URL, NPM_FETCH_TIMEOUT, INSTALLED_PACKAGE_JSON, USER_OPENCODE_CONFIG, USER_OPENCODE_CONFIG_JSONC, } from "./constants.js";
import { logAutoUpdate } from "./logging.js";
function getEntryPackageName(entry) {
...
function isKnownLocalDevEntry(entry) {
